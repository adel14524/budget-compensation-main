...
if(Input::exists()){
  ...
  $data = $budgetobject->searchBudgetCompany($comp, $year);

  $revenueobject = new Revenue();
  $revenuedata = $revenueobject->searchRev($comp, $year);
      ...
      if ($revenuedata) {
        ...
        <div class='card box rounded-0'>
          <div class='card-body text-center'>
            <b>Opss ! Please set your revenue first before adding any expenses.</b><br><br>
            <div class='text-center'>
              <a href='budget-revenue.php'>
                <button type='button' class='btn btn-success shadow-sm'>Go to Revenue</button>
              </a>
            </div>
          </div>
        </div>
