...
if(Input::exists()){
	$updatekeyresultprogressID = escape(Input::get('updatekeyresultprogressID'));
	$keyresultprogress = escape(Input::get('keyresultprogress'));
	$confidencelevel = escape(Input::get('confidencelevel'));
	$KRdescribe = escape(Input::get('KRdescribe'));
	$keyresultprogressobjectiveID = escape(Input::get('keyresultprogressobjectiveID'));
