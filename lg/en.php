<?php
	...
	[
		...
		"keyactivity" => "Key Activities",
		"showkeyactivity" => "Show <b>Doer</b> Activity",
		...
		"noactivityfound" => "No Activities founds",
		"noactivityfoundexplain" => "You haven't create any Activities for Key Result",
		...
		"activityexcellent" => "Congrats for achieve your Activity",

		"successaddactivity" => "You have successfully added an Activity",
		"successaddactivityexplain" => "What's your next step?",
		"successaddactivitybutton" => "Add More Activity",

		"deleteactivity" => "Are you sure you want to delete this Activities?",
		"successdeleteactivity" => "You have successfully Delete an Activity",

		"successeditactivity" => "You have successfully edit an Activity",

		"successupdateactivity" => "You have successfully Update an Activity",
		...
		"deletekeyresultexplain" => "Just note that the <i>Activities</i> under this <b>Key Result</b> will also delete.",
